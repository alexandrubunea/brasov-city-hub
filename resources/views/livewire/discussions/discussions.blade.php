        ...
        <div x-data="{
            ...
            <div class="flex flex-col lg:flex-row gap-5 lg:gap-10 mb-10">
                <div class="flex items-center">
                    <input id="cultural-event" type="checkbox" value=""
                ...
                <div class="flex items-center">
                    <input id="other" type="checkbox" value=""
                        class="w-4 h-4 text-indigo-950 bg-indigo-100 border-gray-300 rounded focus:ring-indigo-500 focus:ring-2">
                    <label for="other" class="ms-2 text-sm font-medium"><i class="fa-solid fa-boxes-stacked"></i> Other</label>
                </div>
            </div>
    ...
    <div class="p-5 rounded-lg bg-gradient-to-br from-indigo-700 to-violet-900 text-zinc-200">
        ...
        <div class="px-5 mt-3 flex flex-col lg:flex-row gap-5">
            <h1 wire:click="setOrderBy('hotness')"
                class="@if ($order_by != 'hotness') text-zinc-400 @endif uppercase font-bold text-xl border-b border-b-indigo-500 pb-3 lg:pb-0 lg:border-b-0 lg:border-r lg:border-indigo-500 lg:pr-5 hover:cursor-pointer">
                <i class="fa-solid fa-fire"></i> Hottest
            </h1>
            <h1 wire:click="setOrderBy('latest')"
                class="@if ($order_by != 'latest') text-zinc-400 @endif uppercase font-bold text-xl border-b border-b-indigo-500 pb-3 lg:pb-0 lg:border-b-0 lg:border-r lg:border-indigo-500 lg:pr-5 hover:cursor-pointer">
                <i class="fa-solid fa-clock-rotate-left"></i> Latest
            </h1>
            <h1 wire:click="setOrderBy('most_liked')"
                class="@if ($order_by != 'most_liked') text-zinc-400 @endif uppercase font-bold text-xl hover:cursor-pointer">
                <i class="fa-solid fa-heart"></i> Most Liked
            </h1>
        </div>
        <hr class="my-5 border-indigo-500">
        <div class="flex flex-col gap-5">
            <livewire:Discussions.Discussion />
            <livewire:Discussions.Discussion />
            <livewire:Discussions.Discussion />
            <livewire:Discussions.Discussion />
        </div>
